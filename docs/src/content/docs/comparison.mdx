...
[Astro](https://astro.build) is the web framework for building content-driven websites like blogs, marketing, and e-commerce. It is host agnostic and comes with official adapters for Cloudlare, Netlify, Node and Vercel.
...
- Vite Deploy's Cloudflare adapter uses the Vite plugin under the hood, and adds [prerendering](#TODO:) capabilities.
...
- It only supports building for [Tanstack Start](#TODO:).
- Vite Deploy's Netlify adapter uses the Vite plugin under the hood, and adds [prerendering](#TODO:) capabilities as well as request handling with the Netlify context.
